...
namespace CMSProjectServer.DAL.Migrations
{
    ...
    [Migration("20240116221242_Optional_Category")]
    partial class Optional_Category
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CMSProjectServer.Domain.Entities.OldSite", b =>
                {
                    ...
                    b.Property<JsonObject>("SiteContent")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("CMSProjectServer.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "374e159e-f851-43b8-ad36-f01174e4ccc0",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEzrXUnuNz5H4B+JXEZvm5OF9tsiV0f7PrqVHj7OWyoX8eu0FPILM7jRbjfOcFy4Ww==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "273f1699-6a40-465a-abef-f7c24f44525c",
            ...
            modelBuilder.Entity("CMSProjectServer.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasOne("CMSProjectServer.Domain.Entities.ArticleCategory", "Category")
                        .WithMany("Articles")
